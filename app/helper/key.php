...
//                [
//                    [
//                        'text' => "💥 ۲۹۹ سکه💰۵۱,۰۰۰ تومان(محدود)",
//                        'callback_data' => "pay-51000-299"
//                    ]
//                ],
                [
                    [
                        'text' => "🥉 ۱۰ سکه💰۱۰ هزار تومان",
                        'callback_data' => "pay-10000-10"
                    ]
                ],
                [
                    [
                        'text' => "🥈 ۶۰ سکه💰۳۰ هزار تومان",
                        'callback_data' => "pay-30000-60"
                    ]
                ],
                [
                    [
                        'text' => "🥇 ۱۲۰ سکه💰۵۵ هزار تومان",
                        'callback_data' => "pay-55000-120"
                    ]
                ],
                [
                    [
                        'text' => "💎 ۲۵۰ سکه 💰 ۱۰۰ هزار تومان",
...
if (!function_exists('noCoinButton')) {
    function noCoinButton()
    {
        return keyboard::make([
            'inline_keyboard' => [
//                [
//                    [
//                        'text' => "💥 ۱۵۵ سکه💰۴۹,۵۰۰ تومان(محدود)",
//                        'callback_data' => "pay-49500-155"
//                    ]
//                ],
//                [
//                    [
