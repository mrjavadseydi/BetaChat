    ...
    function coinButton()
    {
        return keyboard::make([
            'inline_keyboard' => [
                [
                    [
                        'text' => "🥉بسته برنزی ۴۵ سکه💰۱۰ هزار تومان(۱۰٪ تخفیف)",
                        'callback_data' => "pay-15000-45"
                    ]
                ],
                [
                    [
                        'text' => "🥈بسته نقره ای ۱۱۰ سکه💰۳۰ هزار تومان(۱۵٪تخفیف)",
                        'callback_data' => "pay-30000-110"
                    ]
                ],
                [
                    [
                        'text' => "🥇بسته طلایی ۲۲۰ سکه💰۵۰ هزار تومان(۱۷٪تخفیف)",
                        'callback_data' => "pay-50000-220"
                    ]
                ],
                [
                    [
                        'text' => "💎بسته الماس ۵۵۰ سکه 💰 ۷۰ هزار تومان(۲۱٪تخفیف)",
